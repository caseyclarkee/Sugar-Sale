...
export default function Home() {
  return (
    <section className="py-10 px-8">
      <div className="relative w-full rounded-2xl border-[4px] border-black bg-purple shadow-[6px_6px_0_#000] p-8 text-center text-yellow">
        <h2 className="text-5xl font-black uppercase mb-6 drop-shadow-[2px_2px_0_#000]">
          Sugar Liquidation! Sale!
        </h2>
        <div className="absolute right-6 top-6">
          <Burst className="h-28 w-28">
