  ...
  />
        ...
        <div className="mt-12 flex justify-center gap-10">
          ...
          <a href="https://www.instagram.com/longwhite.nz" target="_blank" rel="noopener noreferrer">
            <img src="/icons/instagram.png" alt="Instagram" className="w-16 h-16 icon-float icon-delay-2" />
          </a>
          <a href="https://www.facebook.com/longwhite.nz" target="_blank" rel="noopener noreferrer">
            <img src="/icons/facebook.png" alt="Facebook" className="w-16 h-16 icon-float icon-delay-3" />
          </a>
        </div>
      </div>
    </section>
