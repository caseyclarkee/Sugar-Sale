    ...
    <section className="space-y-8 px-4 py-12 sm:px-8">
      ...
      {activeItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
          <div className="w-full max-w-[92vw] sm:max-w-[92vw] md:max-w-[92vw] lg:max-w-4xl rounded-xl border-[4px] border-black bg-white p-4 md:p-5 lg:p-6 shadow-[6px_6px_0_#000]">
