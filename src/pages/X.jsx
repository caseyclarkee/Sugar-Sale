...
>
<section className="px-6 sm:px-12 py-0 text-lg"> {/* removed top and bottom padding */}
...
<div className="col-span-12 md:col-span-4 order-1 md:order-2 flex flex-col items-center text-center gap-5 md:gap-6">
