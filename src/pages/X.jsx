    ...
    >
      <section className="px-6 sm:px-12 py-10 lg:py-16 text-lg">
        ...
        <div className="grid grid-cols-12 gap-6 md:gap-8 items-end">
          {/* LEFT: Gary + Text + GIF (text vertically centered, Gary static bottom) */}
          <div className="col-span-12 md:col-span-6 order-2 md:order-1 flex flex-col items-center md:items-start text-center md:text-left relative">
            <div className="flex flex-col justify-center h-full absolute inset-0 md:static">
            ...
            <img
              ...
              className="block w-auto max-h-[520px] md:self-start relative z-10"
            />
          </div>

          {/* RIGHT: Can image (unchanged position) */}
          <div className="col-span-12 md:col-span-6 order-1 md:order-2 flex justify-center md:justify-end items-end">
            <img
              src={Can}
